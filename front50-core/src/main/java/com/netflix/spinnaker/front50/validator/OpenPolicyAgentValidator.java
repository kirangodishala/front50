...
public class OpenPolicyAgentValidator implements PipelineValidator {
  ...
  /* define configurable variables:
    ...
    isOpaProxy : true implies Proxy is present else OPA server.
    deltaVerification: if true, fetch and add current pipeline along with new pipeline
  */
  ...
  public void validate(Pipeline pipeline, Errors errors) {
    ...
    try {
      ...
      if (isOpaProxy) {
        ...
        /* process response to conclude allow or deny */
